...
#load images
RED_SHIP = pygame.image.load(os.path.join("./Galaxy Invader" ,"Version 0", "Resources", "red_enemy_ship.png"))
BLUE_SHIP = pygame.image.load(os.path.join("./Galaxy Invader" ,"Version 0", "Resources", "blue_enemy_ship.png"))
GREEN_SHIP = pygame.image.load(os.path.join("./Galaxy Invader" ,"Version 0", "Resources", "green_enemy_ship.png"))

#main player ship image
PLAYER_SHIP = pygame.image.load(os.path.join("./Galaxy Invader" ,"Version 0", "Resources", "player_ship.png"))

#lasers
RED_LASER = pygame.image.load(os.path.join("./Galaxy Invader" ,"Version 0", "Resources", "red_laser.png"))
BLUE_LASER = pygame.image.load(os.path.join("./Galaxy Invader" ,"Version 0", "Resources", "blue_laser.png"))
GREEN_LASER = pygame.image.load(os.path.join("./Galaxy Invader" ,"Version 0", "Resources", "green_laser.png"))
YELLOW_LASER = pygame.image.load(os.path.join("./Galaxy Invader" ,"Version 0", "Resources", "yellow_laser.png"))

#background
BACKGROUND = pygame.transform.scale(pygame.image.load(os.path.join("./Galaxy Invader" ,"Version 0", "Resources", "background.png")), (WIDTH, HEIGHT))
