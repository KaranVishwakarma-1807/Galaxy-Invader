...
pygame.display.set_caption("Galaxy Invader Version 1.1")

#load sounds
DAMAGE = pygame.mixer.Sound(os.path.join("./Galaxy Invader" ,"Version 1.1", "Resources", "damage.wav"))
GAME_OVER = pygame.mixer.Sound(os.path.join("./Galaxy Invader" ,"Version 1.1", "Resources", "game_over.wav"))
INTRO = pygame.mixer.Sound(os.path.join("./Galaxy Invader" ,"Version 1.1", "Resources", "intro.wav"))
LIFE_LOST = pygame.mixer.Sound(os.path.join("./Galaxy Invader" ,"Version 1.1", "Resources", "life_lost.wav"))
PLAYER_LASER = pygame.mixer.Sound(os.path.join("./Galaxy Invader" ,"Version 1.1", "Resources", "player_laser.wav"))
PLAYER_LASER.set_volume(0.1)
QUIT_BUTTON = pygame.mixer.Sound(os.path.join("./Galaxy Invader" ,"Version 1.1", "Resources", "quit_button.wav"))
QUIT_BUTTON.set_volume(2.5)
LEVEL_UP = pygame.mixer.Sound(os.path.join("./Galaxy Invader" ,"Version 1.1", "Resources", "level_up.wav"))
ENEMY_DESTROYED = pygame.mixer.Sound(os.path.join("./Galaxy Invader" ,"Version 1.1", "Resources", "enemy_destroyed.wav"))
GAME_MUSIC = pygame.mixer.Sound(os.path.join("./Galaxy Invader" ,"Version 1.1", "Resources", "background_music.wav"))
GAME_MUSIC.set_volume(1.5)

#load images
RED_SHIP = pygame.image.load(os.path.join("./Galaxy Invader" ,"Version 1.1", "Resources", "red_enemy_ship.png"))
BLUE_SHIP = pygame.image.load(os.path.join("./Galaxy Invader" ,"Version 1.1", "Resources", "blue_enemy_ship.png"))
GREEN_SHIP = pygame.image.load(os.path.join("./Galaxy Invader" ,"Version 1.1", "Resources", "green_enemy_ship.png"))

#icon
ICON = pygame.image.load(os.path.join("./Galaxy Invader" ,"Version 1.1", "Resources", "icon.png"))
pygame.display.set_icon(ICON)

#main player ship
PLAYER_SHIP = pygame.image.load(os.path.join("./Galaxy Invader" ,"Version 1.1", "Resources", "player_ship.png"))

#lasers
RED_LASER = pygame.image.load(os.path.join("./Galaxy Invader" ,"Version 1.1", "Resources", "red_laser.png"))
BLUE_LASER = pygame.image.load(os.path.join("./Galaxy Invader" ,"Version 1.1", "Resources", "blue_laser.png"))
GREEN_LASER = pygame.image.load(os.path.join("./Galaxy Invader" ,"Version 1.1", "Resources", "green_laser.png"))
YELLOW_LASER = pygame.image.load(os.path.join("./Galaxy Invader" ,"Version 1.1", "Resources", "yellow_laser.png"))

#background
BACKGROUND = pygame.transform.scale(pygame.image.load(os.path.join("./Galaxy Invader" ,"Version 1.1", "Resources", "background.png")), (WIDTH, HEIGHT)).convert()
